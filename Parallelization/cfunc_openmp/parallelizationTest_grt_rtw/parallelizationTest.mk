###########################################################################
## Makefile generated for Simulink model 'parallelizationTest'. 
## 
## Makefile     : parallelizationTest.mk
## Generated on : Mon Sep 14 12:17:55 2020
## MATLAB Coder version: 3.3 (R2017a)
## 
## Build Info:
## 
## Final product: $(RELATIVE_PATH_TO_ANCHOR)/parallelizationTest.exe
...
PRODUCT_NAME              = parallelizationTest
MAKEFILE                  = parallelizationTest.mk
COMPUTER                  = PCWIN64
...
MASTER_ANCHOR_DIR         = 
START_DIR                 = C:/Users/tsu/Desktop/Personal/Projects/matlab/Parallelization/cfunc_openmp
ARCH                      = win64
SOLVER                    = 
SOLVER_OBJ                = 
CLASSIC_INTERFACE         = 0
...
MODELREF_LINK_RSPFILE_NAME = parallelizationTest_ref.rsp
RELATIVE_PATH_TO_ANCHOR   = ..
MODELREF_LINK_RSPFILE     = parallelizationTest_ref.rsp
...
PRODUCT = $(RELATIVE_PATH_TO_ANCHOR)/parallelizationTest.exe
...
INCLUDES_BUILDINFO = -I$(START_DIR) -I$(MATLAB_ROOT)/simulink/include/sf_runtime -I$(START_DIR)/parallelizationTest_grt_rtw -I$(MATLAB_ROOT)/extern/include -I$(MATLAB_ROOT)/simulink/include -I$(MATLAB_ROOT)/rtw/c/src -I$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
...
DEFINES_STANDARD = -DMODEL=parallelizationTest -DNUMST=1 -DNCSTATES=0 -DHAVESTDIO -DRT -DUSE_RTMODEL
...
SRCS = $(START_DIR)/parallelizationTest_grt_rtw/parallelizationTest.c $(START_DIR)/parallelizationTest_grt_rtw/parallelizationTest_data.c $(START_DIR)/parallelizationTest_grt_rtw/rtGetInf.c $(START_DIR)/parallelizationTest_grt_rtw/rtGetNaN.c $(START_DIR)/parallelizationTest_grt_rtw/rt_nonfinite.c rt_logging.c
...
OBJS = parallelizationTest.obj parallelizationTest_data.obj rtGetInf.obj rtGetNaN.obj rt_nonfinite.obj rt_logging.obj
...
%.obj : $(START_DIR)/parallelizationTest_grt_rtw/%.c
	$(CC) $(CFLAGS) -o "$@" "$<"


%.obj : $(START_DIR)/parallelizationTest_grt_rtw/%.cpp
	$(CPP) $(CPPFLAGS) -o "$@" "$<"
