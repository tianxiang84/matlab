# File    : parallelizationTest.mk (for Release 2010b and later)
#
# Abstract:
...
MAKECMD         = C:\VeriStand\2017\ModelInterface\tmw\toolchain\Linux_64_GNU_Setup.bat && cs-make
HOST            = PC
BUILD           = yes 
SYS_TARGET_FILE = NIVeriStand_Linux_64.tlc
...
MODULES         		= ni_modelframework.c parallelizationTest_data.c rtGetInf.c rtGetNaN.c rt_nonfinite.c rt_logging.c
...
MASTER_ANCHOR_DIR    	= 
START_DIR          		= C:/Users/tsu/Desktop/Personal/Projects/matlab/Parallelization/parfor
S_FUNCTIONS     		= 
S_FUNCTIONS_LIB 		= 
SOLVER          		= 
NUMST           		= 1
...
NIVERISTAND_LIB_DIR     	= $(NIVERISTAND_ROOT)/ModelInterface/tmw/lib/x86_64/gcc/$(GCC_VERSION)/$(MATLAB_VERSION)
ifeq ($(DEBUG_BUILD),1)
...
MODELLIB                  = parallelizationTestlib.lib
MODELREF_LINK_LIBS   	  = 
MODELREF_INC_PATH         = 
...
# Optimize for most common x64 processors
CPU	= generic
AR 	= x86_64-nilrt-linux-ar.exe
LD	= x86_64-nilrt-linux-ld.exe
RM 	= cs-rm.exe
...
ADD_INCLUDES = \
	...
	-I$(START_DIR)/parallelizationTest_niVeriStand_Linux_64_rtw \
...
# Required Options
CC_OPTS	= -c -fdollars-in-identifiers -mtune=$(CPU) -m64 -fPIC -Wall -MD -fvisibility=protected
